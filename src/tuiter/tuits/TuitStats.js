...
const TuitStats = ({tuit}) => {
    ...
    return(
        <div className="m-3 wd-bookmark-footer d-flex justify-content-between" > 
                ...
                <a href="#" className="wd-bookmark-dislike">
                    <i onClick={() => dispatch(updateTuitThunk({...tuit, dislikes: tuit.dislikes + 1}))} className = "fa fa-thumbs-down" aria-hidden="true" style={{color:"black"}}><span className="m-2 wd-count" style={{"color":"black"}}>{tuit.dislikes}</span></i>
                </a>
